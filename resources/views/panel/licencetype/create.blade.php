         ...
         <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5 style="display: inline;">Create Licence Type</h5>
                ...
                <div class="card-body">
                    <form action="{{ route('licencetype.store') }}" method="post">
                        @csrf
                        <div class="col-sm-6">
                            <div class="form-group">
                                <strong>Licence Type Name <span class="text-danger">*</span> </strong>
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control form-control-sm mt-2" placeholder="Enter Licence Type Name">
