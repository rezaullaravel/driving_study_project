        ...
        <div class="row justify-content-center mx-0">
            ...
            <div class="col-xl-5 col-lg-6 col-md-8 px-0">
                <div class="login-box">
                    ...
                    <h4 class="title fw--300">Sign In to create your session.</h4>
                  ...
                  <form action="{{ route('user.login') }}" method="post">
                    @csrf
                        ...
                        <div class="mb-4">
                            <div class="form-group">
                                <label class="mb-2 form--label text--white">Passwords</label>
                    ...
                    {{-- <div class="login-meta d-flex flex-nowrap mb-4" data-wow-delay="0.5s">
                     ...
                     <button type="submit" class="btn btn-base btn-lg w-100">Sign In</button>
                  </form>

                    <div class="mt-5 text-center">
                        <p>haven't an account ? <a href="{{ url('/register') }}" class="text-success">Please  Register here..</a></p>
